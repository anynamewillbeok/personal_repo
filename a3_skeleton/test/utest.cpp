...
TEST(LaserProcessing,CountReturns){
    ...
    std::string bag_filename=package_share_directory + "/data/sample"; // The data for the bag are in the data folder and each folder (such as sample folder here)
    ...
    while (reader.has_next()) {
        ...
        if (msg->topic_name != "/husky/laserscan") {
            continue;
        }
